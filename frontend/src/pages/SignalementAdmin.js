...
export default function SignalementsAdmin() {
  ...
  useEffect(() => {
    const fetchSignalements = async () => {
      try {
        const res = await API.get("/signalements"); // endpoint backend pour admins/managers
  ...
  return (
    <div className="min-h-screen px-6 py-10">
      <h1 className="text-3xl font-bold mb-6">Tous les signalements</h1>
